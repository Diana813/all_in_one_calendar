    ...
    public void deleteFromDatabase() {
        ...
        if (eventNames != null) {
            for (int i = 0; i < eventNames.size(); i++) {
                ...
                Event eventToDelete = eventsDao.findByEventKindAndName(eventNames.get(i), EventKind.EVENTS.getIntValue());

                eventsDao.deleteByPickedDateKindAndName(BackgroundActivityExpandedDayView.currentDate, EventKind.EVENTS.getIntValue(), eventNames.get(i));

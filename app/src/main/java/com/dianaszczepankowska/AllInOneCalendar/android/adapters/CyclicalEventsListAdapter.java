...
import com.dianaszczepankowska.AllInOneCalendar.android.events.cyclicalEvents.CyclicalEventsDetails;
...
public class CyclicalEventsListAdapter extends RecyclerView.Adapter<CyclicalEventsListAdapter.CyclicalEventsViewHolder> {
    ...
    public CyclicalEventsListAdapter(Context context) {
    ...
    public void onBindViewHolder(@NonNull CyclicalEventsViewHolder holder, int position) {
        ...
        if (event != null) {
            ...
            LocalDate upcomingEvent = UpcomingCyclicalEvent.displayNextEvent(event.getPickedDay(), event.getFrequency(), pickedDaysOfWeek, event.getTerm(), context);
            ...
            if (previousEvent != null) {
                previousEventDate = UpcomingCyclicalEvent.displayNextEvent(previousEvent.getPickedDay(), previousEvent.getFrequency(), pickedDaysOfWeek, previousEvent.getTerm(), context);
            } else {
            ...
            if (previousEventDate != null &&
                    ...
                    (upcomingEvent.isAfter(previousEventDate))) {

...
import com.dianaszczepankowska.AllInOneCalendar.android.personalGrowth.Plan;
...
public class PlansRecyclerViewAdapter extends RecyclerView.Adapter<PlansRecyclerViewAdapter.BigPlanViewHolder> {
    ...
    public PlansRecyclerViewAdapter(Context context) {
        this.layoutInflater = LayoutInflater.from(context);
        PlansRecyclerViewAdapter.context = context;
    }
    ...
    public void setAimsList(List<BigPlanData> aimsList) {
    ...
    public void onBindViewHolder(@NonNull BigPlanViewHolder holder, int position) {
        ...
        //The only way which worked to change checkbox color withouth changing the AppTheme
        int[][] states = {{android.R.attr.state_checked}, {}};
        int[] colors = {context.getColor(R.color.blueZilla), context.getColor(R.color.checkboxGreyZilla)};
    ...
    public void deleteItem(int position) {
        ...
        String id = UtilsEvents.createEventId(bigPlanData.getStartDate());
        aimStrings.add(new StringsAims(aimIndex, aimContent, id));
        aimsList.remove(position);
        deleteFromDatabase();
        notifyItemRemoved(position);
        showUndoSnackbar();
        //findDeletedAimPositionInToDoList(aimContent);
        //toDoListStrings.add(new StringsAims(currentString, aimToDelete, id));
    }

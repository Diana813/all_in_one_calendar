    ...
    public void onBindViewHolder(@NonNull CyclicalEventsViewHolder holder, int position) {
        ...
        if (event != null) {
            ...
            if (previousEvent != null &&
                    ...
                    (upcomingEvent.isAfter(UpcomingCyclicalEvent.displayNextEvent(previousEvent.getPickedDay(), previousEvent.getFrequency(), pickedDaysOfWeek, previousEvent.getTerm(), context)))) {

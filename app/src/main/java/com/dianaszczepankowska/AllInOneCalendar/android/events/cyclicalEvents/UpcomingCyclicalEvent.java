...
public class UpcomingCyclicalEvent {
    ...
    public static LocalDate displayNextEvent(String startDate, String frequency, String pickedDaysOfWeek, String term, Context context) {
        ...
        if (frequency.substring(0, 6).equals("0-0-0-")) {
            ...
            nextEvent = displayDateIfTheFrequencyIsMonths(parts, pickedStartDate, frequency, term, context);
    ...
    private static LocalDate displayDateIfTheFrequencyIsDays(String[] parts, LocalDate pickedStartDate, String term) {
    ...
    private static LocalDate displayDateIfTheFrequencyIsWeeks(String[] parts, LocalDate pickedStartDate, String pickedDaysOfWeek, String term) {
    ...
    private static LocalDate displayDateIfTheFrequencyIsMonths(String[] parts, LocalDate
            pickedStartDate, String frequency, String term, Context context) {
        ...
        if (frequency.contains("*months")) {
            ...
            if (pickedStartDate != null) {
                ...
                String whichWeek = settingsMonths.findDayOfWeekOccurence(whichWeekOfMonth, context);
    ...
    private static LocalDate displayDateIfTheFrequencyIsYears(String[] parts, LocalDate
            pickedStartDate, String term) {

        String howManyYears = parts[0];
        if(howManyYears.equals("")){
            howManyYears = "0";
        }
        int howManyTimesLoop = howManyTimesRepeatEvent(term);
    ...
    private static int howManyTimesRepeatEvent(String term) {
    ...
    static LocalDate pickedFinishDate(String term) {
    ...
    static ArrayList<LocalDate> listOfDates(LocalDate pickedStartDate, String pickedDaysOfWeek, String howManyWeeks) {

...
class WidgetData {
    ...
    static List<CalendarViews> widgetData(Context context) {
        ...
        while (calendarViewsArrayList.size() < 42) {
            ...
            List<Event> cyclicalEvents = cyclicalEventsDao.findByKindOrderedByName(0);
        ...
        for (
            ...
            if (DialogsUtils.isEqualOrBetweenDates(calendarView.getmCalendarFill(), today, today.plusDays(7))) {
